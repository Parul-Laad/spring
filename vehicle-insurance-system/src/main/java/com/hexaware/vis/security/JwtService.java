package com.hexaware.vis.security;
...
public class JwtService {
	...
	private static final long JWT_EXPIRATION =3_600_000; // 60 minutes
	...
	private String createToken(Map<String, Object> claims, String email) {
		...
		return Jwts.builder().setClaims(claims).setSubject(email).setIssuedAt(issuedAt)
